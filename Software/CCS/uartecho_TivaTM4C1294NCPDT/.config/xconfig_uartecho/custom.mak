...
linker.cmd: package/cfg/uartecho_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/uartecho_pem4fcfg.cmd\)\"$""\"/home/mrdtdev/Motherboard/Software/CCS/uartecho_TivaTM4C1294NCPDT/.config/xconfig_uartecho/\1\""' package/cfg/uartecho_pem4f.xdl > $@
