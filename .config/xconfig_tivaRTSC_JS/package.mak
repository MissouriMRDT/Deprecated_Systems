...
override PKGDIR = xconfig_tivaRTSC_JS
...
package/%.xdc.inc package/%_xconfig_tivaRTSC_JS.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_tivaRTSC_JS" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: tivaRTSC_JS.pem4f

-include package/cfg/tivaRTSC_JS_pem4f.mak
-include package/cfg/tivaRTSC_JS_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/tivaRTSC_JS_pem4f.dep
endif
tivaRTSC_JS.pem4f: package/cfg/tivaRTSC_JS_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
tivaRTSC_JS.pem4f package/cfg/tivaRTSC_JS_pem4f.c: .libraries,em4f
endif

package/cfg/tivaRTSC_JS_pem4f.c package/cfg/tivaRTSC_JS_pem4f.h package/cfg/tivaRTSC_JS_pem4f.xdl: override _PROG_NAME := tivaRTSC_JS.xem4f
package/cfg/tivaRTSC_JS_pem4f.c: package/cfg/tivaRTSC_JS_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/tivaRTSC_JS_pem4f.cfg
	-$(RM) package/cfg/tivaRTSC_JS_pem4f.dep
	-$(RM) package/cfg/tivaRTSC_JS_pem4f.c
	-$(RM) package/cfg/tivaRTSC_JS_pem4f.xdc.inc

clean,em4f::
	-$(RM) tivaRTSC_JS.pem4f
.executables,em4f .executables: tivaRTSC_JS.xem4f

tivaRTSC_JS.xem4f: |tivaRTSC_JS.pem4f

-include package/cfg/tivaRTSC_JS.xem4f.mak
tivaRTSC_JS.xem4f: package/cfg/tivaRTSC_JS_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/tivaRTSC_JS_pem4f.oem4f   package/cfg/tivaRTSC_JS_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
tivaRTSC_JS.xem4f: export C_DIR=
tivaRTSC_JS.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

tivaRTSC_JS.test test,em4f test: tivaRTSC_JS.xem4f.test

tivaRTSC_JS.xem4f.test:: tivaRTSC_JS.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 tivaRTSC_JS.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.tivaRTSC_JS.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,tivaRTSC_JS.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) tivaRTSC_JS.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
tivaRTSC_JS_pem4f.oem4f,copy : package/cfg/tivaRTSC_JS_pem4f.oem4f
tivaRTSC_JS_pem4f.sem4f,copy : package/cfg/tivaRTSC_JS_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_tivaRTSC_JS
xconfig_tivaRTSC_JS.tar: package/package.bld.xml
xconfig_tivaRTSC_JS.tar: package/build.cfg
xconfig_tivaRTSC_JS.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_tivaRTSC_JS.tar.dep
endif
package/rel/xconfig_tivaRTSC_JS/xconfig_tivaRTSC_JS/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_tivaRTSC_JS.tar: package/rel/xconfig_tivaRTSC_JS.xdc.inc package/rel/xconfig_tivaRTSC_JS/xconfig_tivaRTSC_JS/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_tivaRTSC_JS.xdc.inc,package/rel/xconfig_tivaRTSC_JS.tar.dep)


release release,xconfig_tivaRTSC_JS: all xconfig_tivaRTSC_JS.tar
clean:: .clean
	-$(RM) xconfig_tivaRTSC_JS.tar
	-$(RM) package/rel/xconfig_tivaRTSC_JS.xdc.inc
	-$(RM) package/rel/xconfig_tivaRTSC_JS.tar.dep
