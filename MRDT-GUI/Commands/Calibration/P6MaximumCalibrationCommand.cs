namespace MRDT_GUI.Commands
{
    ...
    class P6MaximumCalibrationCommand : ICommand
    {
        public P6MaximumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P6CalibrationMaximum = _stateModel.Potentiometer6;
        }
