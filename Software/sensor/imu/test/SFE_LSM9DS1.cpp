...
LSM9DS1::LSM9DS1(interface_mode interface, uint8_t agAddr, uint8_t mAddr)
{
...
{
  /* CTRL_REG1_G sets output data rate, full-scale, and bandwidth
...
{ 
  ...
  mWriteByte(CTRL_REG1_M, 0B00010000); // no temp comp, low-power performance, 10Hz ODR, no self test
  ...
  mWriteByte(CTRL_REG3_M, 0B00000011); // I2C enable, LP disable, SPI r/w operations enable, power-down mode (default)
