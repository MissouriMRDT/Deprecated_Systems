namespace MRDT_GUI.Commands
{
    ...
    class P4MinimumCalibrationCommand : ICommand
    {
        public P4MinimumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P4CalibrationMinimum = _stateModel.Potentiometer4;
        }
