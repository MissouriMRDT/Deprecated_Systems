...
public:
  ...
  signed short temperature; // temperature reading
  // Variable to keep track of calibration status
  bool calibrated = false;

  //signed short gx_calc, gy_calc, gz_calc; // calculated x, y, and z axis readings of the gyroscope
  //signed short ax_calc, ay_calc, az_calc; // calculated x, y, and z axis readings of the accelerometer
  //signed short mx_calc, my_calc, mz_calc; // calculated x, y, and z axis readings of the magnetometer
  float pitch = -1000,
		roll = -1000,
		yaw = -1000 ; // calculated pitch, roll, and yaw readings

  // DC and Scale biases of accel values
  signed short ax_dcbias = 0,
		  ay_dcbias = 0,
		  az_dcbias = 0;
  ...
  LSM9DS1(unsigned char agAddr, unsigned char mAddr);
  ...
  float convGyro(signed short gyro);
  ...
  float convAccel(signed short accel);
  ...
  float convMag(signed short mag);
