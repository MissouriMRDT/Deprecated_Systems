...
// that acts as the RoverMotherboard.cfg roveHardwareTesterTask handle
//
// This task would need to be activated in RoverMotherbaordMain.cfg gui with high pri
//
// BIOS_start in would then init this as the roveHardwareTesterTask Thread
//
// this is a RoverMotherboard.cfg object::roveHardwareTesterTask::
//
// priority 15, vital_flag = t, 2048 persistent private stack

#include "../roveWareHeaders/roveHardwareTester.h"
