...
public:
	...
	float pitch = -1000, roll = -1000, yaw = -1000; // calculated pitch, roll, and yaw readings

	// DC and Scale biases of accel values
	int16_t ax_dcbias = 0, ay_dcbias = 0, az_dcbias = 0;
	float ax_scalebias = 1, ay_scalebias = -1, az_scalebias = 1;

	// DC and Scale biases of mag values
	int16_t mx_dcbias = 13, my_dcbias = -41, mz_dcbias = 25;
