namespace MRDT_GUI.Commands
{
    ...
    class P3MinimumCalibrationCommand : ICommand
    {
        public P3MinimumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P3CalibrationMinimum = _stateModel.Potentiometer3;
        }
