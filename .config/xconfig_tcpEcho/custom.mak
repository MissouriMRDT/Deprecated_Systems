...
linker.cmd: package/cfg/tcpEcho_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/tcpEcho_pem4fcfg.cmd\)\"$""\"/home/mrdtdev/Motherboard/Software/CCS/tcpEcho_TivaTM4C1294NCPDT/.config/xconfig_tcpEcho/\1\""' package/cfg/tcpEcho_pem4f.xdl > $@
