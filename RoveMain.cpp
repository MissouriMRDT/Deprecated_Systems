    ...
    while(FOREVER)
    {
        ...
        switch (data_id) {
            ...
            case DRIVE_LEFT_MOTORS:
                ...
                roveCntrl_DriveMotor_ByPWM(MOTOR_1, motor_speed);
                roveCntrl_DriveMotor_ByPWM(MOTOR_2, motor_speed);
                roveCntrl_DriveMotor_ByPWM(MOTOR_3, -motor_speed);
                break;
            ...
            case DRIVE_RIGHT_MOTORS:
                ...
                roveCntrl_DriveMotor_ByPWM(MOTOR_4, -motor_speed);
                roveCntrl_DriveMotor_ByPWM(MOTOR_5, motor_speed);
                roveCntrl_DriveMotor_ByPWM(MOTOR_6, -motor_speed);
                break;
