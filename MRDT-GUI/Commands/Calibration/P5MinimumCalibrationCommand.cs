namespace MRDT_GUI.Commands
{
    ...
    class P5MinimumCalibrationCommand : ICommand
    {
        public P5MinimumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P5CalibrationMinimum = _stateModel.Potentiometer5;
        }
