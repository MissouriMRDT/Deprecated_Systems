namespace MRDT_GUI.Commands
{
    ...
    class RightMinimumCalibrationCommand : ICommand
    {
        public RightMinimumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.RightCalibrationMinimum = _stateModel.SliderRight;
        }
