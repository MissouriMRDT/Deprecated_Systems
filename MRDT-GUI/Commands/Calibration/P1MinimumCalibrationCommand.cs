namespace MRDT_GUI.Commands
{
    ...
    class P1MinimumCalibrationCommand : ICommand
    {
        public P1MinimumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P1CalibrationMinimum = _stateModel.Potentiometer1;
        }
