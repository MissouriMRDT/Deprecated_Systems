...
public:
  ...
  enum mag_xy_om
  {
	M_XY_OM_L,  // low-power mode (0x00)
	M_XY_OM_M,  // medium-performance mode (0x01)
	M_XY_OM_H,  // high-performance mode (0x02)
	M_XY_OM_UH, // ultra-high performance mode (0x03)
  };

  // mag_z_om defines the Z axis operative mode selection of the magnetometer:
  enum mag_z_om
  {
	M_Z_OM_L,  // low-power mode (0x00)
	M_Z_OM_M,  // medium-performance mode (0x01)
	M_Z_OM_H,  // high-performance mode (0x02)
	M_Z_OM_UH, // ultra-high performance mode (0x03)
  };
  ...
  LSM9DS1(interface_mode interface, uint8_t agAddr, uint8_t mAddr);
