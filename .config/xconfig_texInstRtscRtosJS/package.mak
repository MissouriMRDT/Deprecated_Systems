...
override PKGDIR = xconfig_texInstRtscRtosJS
...
package/%.xdc.inc package/%_xconfig_texInstRtscRtosJS.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_texInstRtscRtosJS" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: texInstRtscRtosJS.pem4f

-include package/cfg/texInstRtscRtosJS_pem4f.mak
-include package/cfg/texInstRtscRtosJS_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/texInstRtscRtosJS_pem4f.dep
endif
texInstRtscRtosJS.pem4f: package/cfg/texInstRtscRtosJS_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
texInstRtscRtosJS.pem4f package/cfg/texInstRtscRtosJS_pem4f.c: .libraries,em4f
endif

package/cfg/texInstRtscRtosJS_pem4f.c package/cfg/texInstRtscRtosJS_pem4f.h package/cfg/texInstRtscRtosJS_pem4f.xdl: override _PROG_NAME := texInstRtscRtosJS.xem4f
package/cfg/texInstRtscRtosJS_pem4f.c: package/cfg/texInstRtscRtosJS_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/texInstRtscRtosJS_pem4f.cfg
	-$(RM) package/cfg/texInstRtscRtosJS_pem4f.dep
	-$(RM) package/cfg/texInstRtscRtosJS_pem4f.c
	-$(RM) package/cfg/texInstRtscRtosJS_pem4f.xdc.inc

clean,em4f::
	-$(RM) texInstRtscRtosJS.pem4f
.executables,em4f .executables: texInstRtscRtosJS.xem4f

texInstRtscRtosJS.xem4f: |texInstRtscRtosJS.pem4f

-include package/cfg/texInstRtscRtosJS.xem4f.mak
texInstRtscRtosJS.xem4f: package/cfg/texInstRtscRtosJS_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/texInstRtscRtosJS_pem4f.oem4f   package/cfg/texInstRtscRtosJS_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
texInstRtscRtosJS.xem4f: export C_DIR=
texInstRtscRtosJS.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/:$(PATH)

texInstRtscRtosJS.test test,em4f test: texInstRtscRtosJS.xem4f.test

texInstRtscRtosJS.xem4f.test:: texInstRtscRtosJS.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 texInstRtscRtosJS.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.texInstRtscRtosJS.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,texInstRtscRtosJS.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) texInstRtscRtosJS.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
texInstRtscRtosJS_pem4f.oem4f,copy : package/cfg/texInstRtscRtosJS_pem4f.oem4f
texInstRtscRtosJS_pem4f.sem4f,copy : package/cfg/texInstRtscRtosJS_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_texInstRtscRtosJS
xconfig_texInstRtscRtosJS.tar: package/package.bld.xml
xconfig_texInstRtscRtosJS.tar: package/build.cfg
xconfig_texInstRtscRtosJS.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_texInstRtscRtosJS.tar.dep
endif
package/rel/xconfig_texInstRtscRtosJS/xconfig_texInstRtscRtosJS/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_texInstRtscRtosJS.tar: package/rel/xconfig_texInstRtscRtosJS.xdc.inc package/rel/xconfig_texInstRtscRtosJS/xconfig_texInstRtscRtosJS/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_texInstRtscRtosJS.xdc.inc,package/rel/xconfig_texInstRtscRtosJS.tar.dep)


release release,xconfig_texInstRtscRtosJS: all xconfig_texInstRtscRtosJS.tar
clean:: .clean
	-$(RM) xconfig_texInstRtscRtosJS.tar
	-$(RM) package/rel/xconfig_texInstRtscRtosJS.xdc.inc
	-$(RM) package/rel/xconfig_texInstRtscRtosJS.tar.dep
