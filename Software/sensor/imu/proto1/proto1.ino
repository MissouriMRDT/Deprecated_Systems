// The LSM9DS1 requires both the SPI and Wire libraries.
// Unfortunately, you'll need to include both in the Arduino
// sketch, before including the LSM9DS1 library.
#include <SPI.h> // Included for LSM9DS1 library
#include <Wire.h>
#include "LSM9DS1.h"
...
//  uint16_t status = dof.begin();
  // Or call it with declarations for sensor scales and data rates:  
   dof.begin(dof.G_SCALE_245DPS, dof.A_SCALE_2G, dof.M_SCALE_4GS,
...
// N is 0/360, E is 90, S is 180, W is 270
