namespace MRDT_GUI.Commands
{
    ...
    class P2MaximumCalibrationCommand : ICommand
    {
        public P2MaximumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P2CalibrationMaximum = _stateModel.Potentiometer2;
        }
