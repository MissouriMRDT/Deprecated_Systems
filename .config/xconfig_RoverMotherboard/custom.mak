...
linker.cmd: package/cfg/RoverMotherboard_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/RoverMotherboard_pem4fcfg.cmd\)\"$""\"/home/mrdtdev/Deprecated-Motherboard/Software/CCS/RoverMotherboard/.config/xconfig_RoverMotherboard/\1\""' package/cfg/RoverMotherboard_pem4f.xdl > $@
