namespace MRDT_GUI.Commands
{
    ...
    class P7MaximumCalibrationCommand : ICommand
    {
        public P7MaximumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P7CalibrationMaximum = _stateModel.Potentiometer7;
        }
