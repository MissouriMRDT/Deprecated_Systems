namespace MRDT_GUI.Commands
{
    ...
    class P6MinimumCalibrationCommand : ICommand
    {
        public P6MinimumCalibrationCommand(NetworkControllerModel network, StateModel state, ConfigurationModel config)
        {
        ...
        {
            _configModel.P6CalibrationMinimum = _stateModel.Potentiometer6;
        }
